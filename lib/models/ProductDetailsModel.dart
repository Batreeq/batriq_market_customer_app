class ProductDetailsModel {
    ...
    ProductDetailsModel({this.barcode, this.category_id, this.created_at, this.details_image, this.details_text, this.details_title, this.id, this.image, this.is_package, this.lang, this.main_category, this.name, this.notice, this.offers_ids, this.points, this.price, this.product_source, this.quantity, this.size, this.special_price_for, this.updated_at, this.wholesale_price});
