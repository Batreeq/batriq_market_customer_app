...
class _LoginDriver extends State{
  ...
  getBody() {
    return SingleChildScrollView(
      ...
      children: <Widget>[
        Center(
            child: Text(sharedData.welcomeTextInLoginDriver,
        ...
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              Text(sharedData.dontHaveAccount, style: sharedData.optionStyle,),
              Padding(
                padding: const EdgeInsets.only(right: 8.0),
                child: InkWell(
                  focusColor: sharedData.yellow,
                  child: Text(
                    sharedData.createAccount, style: sharedData.yellowStyle,),
                  onTap: () {Navigator.of(context).push(MaterialPageRoute(builder:(BuildContext c )=>SignUpDriver() ));},
                ),
              ),
            ],
          ),
        ...
        Center(
            child: Text(
              sharedData.loginUsingText, style: sharedData.optionStyle,)
        ),
        Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: <Widget>[
            InkWell(
              child: Image.asset('assets/images/facebook.png'), onTap: () {},),
            SizedBox(width: 20,),
            InkWell(child: Image.asset('assets/images/googleplus.png'),
              onTap: () {},),
          ],
        ),
      ],
                ...
                child: SizedBox(
                  ...
                  child:  RaisedButton(
                    ...
                    //  _validateAndSubmit();
                      ...
                      Navigator.of(context).push(MaterialPageRoute(builder: (BuildContext c )=> DriverOptionsScreen()));
                    },
                    child: Text('تسجيل دخول' , style: sharedData.appBarTextStyle,),
                  ),
                ),
              )
            ],
