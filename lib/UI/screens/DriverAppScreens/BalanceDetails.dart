...
class BalanceDetailsDriver extends StatefulWidget {
  @override
...
class _BalanceDetails extends State {
  ...
  Widget build(BuildContext context) {
    ...
    userPayments.creditDebt = 'dd';
    userPayments.details = 'rr';
    userPayments.totalBalance = '220';
    userPayments.createdDate = '30-2-3333';
